...
var EventTypeCreateFormComponent = (function () {
    function EventTypeCreateFormComponent(adminService, routeParams) {
        this.adminService = adminService;
        this.routeParams = routeParams;
        this.title = 'Add New Event Type';
        this.eventType = new eventType_1.EventType();
    }
    EventTypeCreateFormComponent.prototype.ngOnInit = function () {
    };
    EventTypeCreateFormComponent.prototype.onSubmit = function () {
        var _this = this;
    ...
    EventTypeCreateFormComponent.prototype.goBack = function () {
        window.history.back();
    };
    EventTypeCreateFormComponent.prototype.myLog = function (value) {
        console.log(value);
    };
    EventTypeCreateFormComponent = __decorate([
        core_1.Component({
    ...
    ], EventTypeCreateFormComponent);
    return EventTypeCreateFormComponent;
}());
exports.EventTypeCreateFormComponent = EventTypeCreateFormComponent;
//# sourceMappingURL=event-type-create-form.component.js.map