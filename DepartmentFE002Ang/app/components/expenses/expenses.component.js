...
var expenses_list_component_1 = require('./expenses-list.component');
var ExpensesComponent = (function () {
    function ExpensesComponent(router) {
        this.router = router;
        this.title = 'Expenses';
    }
    ...
    ExpensesComponent = __decorate([
        core_1.Component({
            ...
            directives: [expenses_list_component_1.ExpensesListComponent]
        }), 
